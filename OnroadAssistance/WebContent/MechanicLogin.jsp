              ...
              <div id="login" class="animate form">
                     <form  action="MechanicRegister"> 
                           ...
                           <p> 
                                  ...
                                  <input id="password" name="password" required="required" type="password" placeholder="exampleS08@" /> 
                           </p>
                           <p class="keeplogin"> 
                           ...
                           <p class="change_link">
                                  Not a member yet ?
                                  <a href="MechanicRegister.jsp" class="to_register">Join us</a>
                           </p>
                     </form>
              </div>
